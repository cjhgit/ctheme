...
<div class="main">
    <section class="section">
        <div class="boundary">
            <header class="section-header">
                <h2 class="section-title">熟悉前端，进阶后端</h2>
    ...
    <section class="section">
        <div class="boundary">
            <header class="section-header">
                <h2 class="section-title">对Web充满热情</h2>
                <h3 class="section-subtitle">对各种新技术有着较浓的兴趣。</h3>
            </header>
            <div class="section-body clearfix">
                ...
                <div class="edu edu-university">
                    <div class="edu__body clearfix">
                        <h3 class="edu-heading">职业期望 & 规划</h3>
                        <p>希望能找到一份前端或者 Java 后端开发的实习工作。</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="boundary">
            <header class="section-header">
                ...
                <h3 class="section-subtitle">呃，看看就好</h3>
            </header>
            <div class="section-body">
                    ...
                    <section class="work-exp-list__company clearfix">
                        <header class="work-exp-list__company__header">
                            <h4 class="work-exp-list__company__header__title">
                                <span style="color: #008558;">网站开发</span>
                            </h4>
                        </header>
                        <div class="work-exp-list__company__body">
                            <p>搭建维护自己的博客，维护二手交易网站和一个公众号。</p>
                        </div>
                    </section>
                    <div class="work-exp-list__point"><i class="work-exp-list__point__ico"></i>2015/7</div>
                    <section class="work-exp-list__company clearfix">
                        <header class="work-exp-list__company__header">
                            <!--
                            <a href="http://www.dvbbs.net/" target="_blank" class="work-exp-list__company__header__logo"><img src="img/cndw-logo.png" alt="动网先锋网络科技有限公司" /></a>
                            -->
                            <h4 class="work-exp-list__company__header__title">
                                <span>校园开发团队</span>
                            </h4>
                            <p class="work-exp-list__company__header__jobtitle">Android、Javaweb 开发</p>
                        </header>
                        <div class="work-exp-list__company__body">
    ...
    <section class="section">
        <div class="boundary">
            <header class="section-header">
                <h2 class="section-title"><!--丰富的-->项目经验</h2>
            ...
            <div class="section-body">
                ...
                <section class="project clearfix">
                    ...
                    <div class="project__thumb">
                        <img src="asset/resume/img/project-ctheme.jpg" alt="Wordpress博客">
                    </div>
                </section>
                <section class="project project--nothumb clearfix">
                    <div class="project-intro">
