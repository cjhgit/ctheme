...
add_action('widgets_init', 'register_tag_widget');

function register_tag_widget() {
...
class TagWidget extends WP_Widget {
	...
	function TagWidget() {
		$widget_ops = array('classname' => 'widget-tag-3d', 'description' => '显示热门标签');
		$this->WP_Widget('widget_tag', 'C-3D标签云（小C主题）', $widget_ops, $control_ops);
	}
