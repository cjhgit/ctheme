		...
		<tr>
			...
			<?php
					if ( empty( $profileuser->simple_local_avatar ) )
						echo '<span class="description">未设置头像</span>';
					else 
						echo '
							<input type="checkbox" name="simple-local-avatar-erase" value="1" /> ' . __('删除上传的头像（删除后使用全球通同头像）', 'simple-local-avatars') . '<br />
							<span class="description">上传新头像或删除上传的头像</span>
						';		
				} else {
					if ( empty( $profileuser->simple_local_avatar ) )
						echo '<span class="description">No local avatar is set. Set up your avatar at Gravatar.com.</span>';
					else 
